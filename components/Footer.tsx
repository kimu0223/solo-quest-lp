      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex flex-col md:flex-row justify-between items-center gap-8">
          ...
          <div className="flex flex-wrap justify-center gap-6 text-sm text-gray-500 font-medium">
            ...
            <Link href="/legal" className="hover:text-white transition">特定商取引法に基づく表記</Link>
            <Link href="/contact" className="hover:text-white transition">お問い合わせ</Link>
          </div>
        </div>
        <div className="mt-12 pt-8 border-t border-white/5 text-center text-gray-600 text-[10px]">
