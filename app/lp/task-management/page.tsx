            ...
            <div className="md:w-1/2 text-center md:text-left">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center md:justify-start gap-4">
                <CTAButton
                  ...
                  eventLabel="task_management_lp_hero"
            ...
            <div className="space-y-16">
              <div className="flex flex-col md:flex-row items-center gap-10">
                <div className="w-full md:w-1/2">
                  <div className="w-full aspect-video rounded-3xl relative overflow-hidden border-4 border-emerald-100 shadow-inner bg-slate-900">
                  <Image
                    src="/screenshots/screen-xp.png"
                    alt="Solo Questアプリ画面"
                    fill
        ...
        <section className="py-20 bg-emerald-700 text-white text-center">
          <div className="max-w-3xl mx-auto px-6">
            ...
            <CTAButton
              ...
              eventLabel="task_management_lp_cta"
