      ...
      <main className="pt-40 pb-20 px-6 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center mb-28 relative">
            <Link
              href="https://forms.gle/xxxxxxxxxxxx" // ★ここに事前登録フォームやアプリのURLを入れてください
              target="_blank"
            ...
            <Link href="/blog" className="w-full sm:w-auto px-10 py-4 clay-card text-teal-800 font-bold text-lg hover:scale-105 hover:text-teal-600 transition-all text-center flex items-center justify-center">
              物語（ブログ）を読む
            </Link>
          </div>
